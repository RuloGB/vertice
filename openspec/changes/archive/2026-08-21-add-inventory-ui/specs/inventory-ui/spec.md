...
The UI MUST distinguish loading, hard scan failure, and successful empty results. A hard failure MUST show a minimal non-blank failure surface; an empty successful report MUST show an empty list region. Rich diagnostics, client/installation/root messaging, and i18n are out of scope.
